...
#define WEB_LOGIN_ID            0
#define WIFI_SSID_ID            1
#define WIFI_PASSSWORD_ID       2
#define DEVICE_NAME_ID          3
#define SYNC_PATH_ID            4
#define PERSON_NAME_ID          5
#define PERSON_ORGANIZATION_ID  6
#define PERSON_JOB_ID           7
#define PERSON_MESSAGE_ID       8
#define SECRET_NAME_ID          9
#define SECRET_ORGANIZATION_ID  10
#define SECRET_JOB_ID           11
#define SECRET_MESSAGE_ID       12
...
typedef struct {
    ...
    char person_organization[NAME_MAX_SIZE];
    char person_job[NAME_MAX_SIZE];
    char person_message[NAME_MAX_SIZE];
