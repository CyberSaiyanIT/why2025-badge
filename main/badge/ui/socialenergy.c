...
static void ui_socialenergy_init_section_styles(section_styles_t *styles, lv_color_t color) {
...
static lv_color_t ui_socialenergy_get_zone_color(int32_t value) {
  if (value < 20)
...
static void ui_socialenergy_add_coffee() { ui_socialenergy_needle_step(10); }
static void ui_socialenergy_add_beer() { ui_socialenergy_needle_step(20); }

lv_obj_t *ui_socialenergy_init() {
  ...
  lv_obj_center(add_button_text);
  lv_obj_add_event_cb(add_button, ui_socialenergy_button_down, LV_EVENT_PRESSED, NULL);
  ...
  lv_obj_center(minus_button_text);
  lv_obj_add_event_cb(minus_button, ui_socialenergy_button_up, LV_EVENT_PRESSED, NULL);
  ...
  lv_obj_center(coffee_button_text);
  lv_obj_add_event_cb(coffee_button, ui_socialenergy_add_coffee, LV_EVENT_PRESSED, NULL);
  ...
  lv_obj_center(beer_button_text);
  lv_obj_add_event_cb(beer_button, ui_socialenergy_add_beer, LV_EVENT_PRESSED, NULL);
  ...
  /* Zone 1: (Grey) */
  ui_socialenergy_init_section_styles(&zone1_styles, lv_palette_main(LV_PALETTE_RED));
  ui_socialenergy_add_section(scale, 0, 20, &zone1_styles);

  /* Zone 2: (Blue) */
  ui_socialenergy_init_section_styles(&zone2_styles, lv_palette_main(LV_PALETTE_ORANGE));
  ui_socialenergy_add_section(scale, 20, 40, &zone2_styles);

  /* Zone 3: (Green) */
  ui_socialenergy_init_section_styles(&zone3_styles, lv_palette_main(LV_PALETTE_GREY));
  ui_socialenergy_add_section(scale, 40, 60, &zone3_styles);

  /* Zone 4: (Orange) */
  ui_socialenergy_init_section_styles(&zone4_styles, lv_palette_main(LV_PALETTE_BLUE));
  ui_socialenergy_add_section(scale, 60, 80, &zone4_styles);

  /* Zone 5: (Red) */
  ui_socialenergy_init_section_styles(&zone5_styles, lv_palette_main(LV_PALETTE_GREEN));
  ui_socialenergy_add_section(scale, 80, 100, &zone5_styles);
  ...
  social_value_label = lv_label_create(container);
...
void ui_socialenergy_button_up() {
  ui_socialenergy_needle_step(-5);
}
void ui_socialenergy_button_down() {
  ui_socialenergy_needle_step(5);
}